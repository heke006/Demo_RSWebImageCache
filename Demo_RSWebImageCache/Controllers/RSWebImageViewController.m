...
#import "RSWebImageViewController.h"
#import "RSWebImageCell.h"
#import "RSWebImageModel.h"

@interface RSWebImageViewController ()<UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, strong) UITableView *tableView;

@property (nonatomic, strong) RSWebImageModel *imageModel;
...
@implementation RSWebImageViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *cellID = @"RSWebImageCell";
    RSWebImageCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID forIndexPath:indexPath];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    return [RSWebImageCell cellHeight];
}
...
- (void)setImageForCell:(RSWebImageCell *)cell forIndexPath:(NSIndexPath *)indexPath{
...
- (void)downloadImageForIndexPath:(NSIndexPath *)indexPath {
    ...
    NSBlockOperation *operation = [NSBlockOperation blockOperationWithBlock:^{
        ...
        [[NSOperationQueue mainQueue] addOperationWithBlock:^{
            ...
            RSWebImageCell *cell = (RSWebImageCell *)[weakSelf.tableView cellForRowAtIndexPath:indexPath];
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"RSWebImageCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"RSWebImageCell"];
    }
    return _tableView;
}
...
- (RSWebImageModel *)imageModel {
    if (!_imageModel) {
        _imageModel = [[RSWebImageModel alloc] init];
    }
    return _imageModel;
}
